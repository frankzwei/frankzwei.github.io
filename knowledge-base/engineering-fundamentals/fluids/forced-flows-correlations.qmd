...
$$
\begin{aligned}
\delta & =0.37x\mathrm{Re}_x^{-0.2} \\
\delta_2 & =0.036x\mathrm{Re}_x^{-0.2}
...
$$
C_f=0.0574\mathrm{Re}_x^{-0.2}tag{5.2.38}
$$
...
$$
\begin{aligned}
\mathrm{St}_x\mathrm{Pr}^{0.4} & =\left.\frac {\mathrm{Nu}_x}{\mathrm{Re}_x\mathrm{Pr}}\right|_{\xi=0}\left[1-\left(\frac {\xi}x\right)^{9/10}\right]^{-1/9} \\
\left.\frac {\mathrm{Nu}_x}{\mathrm{Re}_x\mathrm{Pr}}\right|_{\xi=0} & =0.0287\mathrm{Re}_x^{-0.2}
...
For the dimensionless mean velocity, $U_m^+$, see Yu et al. (2001)'s correlation in @sec-circular-fully-developed-flow-profiles-turbulent.
...
\mathrm{Nu}_{D_H,\mathrm{UWT},2}(x) & =1.841\left(x^*\right)^{-1/3}

...
![](assets/like-doublet-dropsize-velocity-graphs-1.png){.lightbox width=100% fig-align=center}
  
![](assets/like-doublet-dropsize-velocity-graphs-2.png){.lightbox width=100% fig-align=center}

Mass median dropsizes for like-doublet elements against varying injection velocities
:::